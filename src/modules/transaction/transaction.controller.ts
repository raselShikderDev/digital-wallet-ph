...
const viewTransactionsHistory = asyncHandle(async (req:Request, res:Response, next:NextFunction)=>{
...
const singelUserTransaction = asyncHandle(async (req:Request, res:Response, next:NextFunction)=>{
